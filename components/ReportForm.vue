<template>
  ...
  >
    <div
      class="bg-white dark:bg-white/[0.04] rounded-xl w-full max-w-lg max-h-[90vh] overflow-y-auto p-6 space-y-4"
    >
      <div class="flex items-center justify-between">
        <h2 class="text-lg font-bold">Report User</h2>
        <button @click="close" class="text-gray-400 dark:text-zinc-500 hover:text-gray-600 dark:hover:text-zinc-300">
          <svg
            class="w-5 h-5"
            fill="none"
            stroke="currentColor"
      ...
      <div>
        ...
        <select
          v-model="reportType"
          class="w-full border border-gray-300 dark:border-white/[0.10] rounded-lg px-4 py-2.5 text-gray-900 dark:text-zinc-100 focus:border-pokemon-red focus:outline-none focus:ring-1 focus:ring-pokemon-red"
        >
      ...
      <div>
        ...
        <div
          class="border-2 border-dashed border-gray-300 dark:border-white/[0.10] rounded-lg p-4 text-center cursor-pointer hover:border-pokemon-red transition-colors"
        ...
        >
          ...
          />
          <p class="text-sm text-gray-400 dark:text-zinc-500">Click to upload screenshots</p>
      ...
      <div class="flex gap-3">
        <button
          @click="close"
          class="flex-1 py-2.5 rounded-lg border border-gray-300 dark:border-white/[0.10] text-gray-600 dark:text-zinc-300 text-sm font-medium hover:bg-gray-50 dark:hover:bg-white/[0.02] transition-colors"
        >
          Cancel
        </button>
        <button
