# Graph Report - PokeTcg  (2026-08-30)

## Corpus Check
- 286 files · ~389,103 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2663 nodes · 3899 edges · 196 communities (177 shown, 19 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `67b80182`
...
1. `getAdminFirestore()` - 54 edges
2. `requireStaff()` - 28 edges
3. `requireUser()` - 24 edges
4. `isAvailable()` - 18 edges
5. `stateName()` - 17 edges
6. `confirm` - 16 edges
7. `noteError()` - 16 edges
...
- `availableCards` --indirect_call--> `isAvailable()`  [INFERRED]
  pages/index.vue → shared/card-availability.ts
...
Cohesion: 0.12
Nodes (22): PROBES, DELYVA_BASE, DelyvaAddress, delyvaBase(), delyvaConfig(), delyvaConsignmentNo(), DelyvaContact, delyvaCreateOrder() (+14 more)
...
Cohesion: 0.04
Nodes (48): actionHints, addr, addressOpen, { authedFetch }, backLabel, backTo, booking, bookShipment() (+40 more)
...
Cohesion: 0.06
Nodes (47): useSellerKyc(), { authedFetch: syncFetch }, {
  available,
  locked,
  queued,
  paidOut,
  ...
  lastFailureReason,
  requestPayout,
}, bankLine, doRequestPayout(), fmt(), isSubmitted(), { listenSellerCompiledOrders } (+39 more)

### Community 22 - "SellerSalesDashboard.vue"
Cohesion: 0.07
Nodes (27): actionTiles, avgOrder, axisMax, Bucket, byStatus(), chartMax, completedCount, counterDiscount (+19 more)
...
Cohesion: 0.27
Nodes (12): bookShipmentForOrder(), cancelShipmentForOrder(), nextCollection(), NOTE: deliberately does NOT set status to "shipped". Booking a waybill, delyvaCancelOrder(), QuotedShipping, quoteOrderShipping(), stateName() (+4 more)

### Community 34 - "useCompiledOrders.ts"
Cohesion: 0.11
Nodes (20): props, buyerCompiledOrders, CompiledOrder, CompiledOrderInputItem, CompiledOrderItem, CompiledOrderStatus, CompiledPaymentMethod, groupItemsBySeller() (+12 more)
...
Cohesion: 0.11
Nodes (36): noteAction(), burnPasswordTime(), createSession(), destroySession(), hashPassword(), hashToken(), loadRole(), loadRoles() (+28 more)
...
Cohesion: 0.18
Nodes (19): discountOf(), totals, Body, checkStockAvailability(), releaseExpiredReservations(), releaseItems(), settleItems(), StockUnavailableError (+11 more)
...
Cohesion: 0.18
Nodes (21): actualCommission(), BILLPLZ_FPX_FEE, BILLPLZ_PAYOUT_FEE, commissionAtLaunch(), courierCost(), FinanceOrder, FinancePayout, incomeTaxProvision() (+13 more)
...
Cohesion: 0.17
Nodes (13): removeGroup(), confirm, cancelShipment(), handleCancel(), handleMarkDelivered(), bulkMarkSold(), bulkRemove(), clearSelection() (+5 more)

### Community 134 - "account.vue"
Cohesion: 0.15
Nodes (12): busy, current, done, error, first, { mcFetch }, { me, refresh }, mismatch (+4 more)

### Community 135 - "merge.post.ts"
Cohesion: 0.24
...
Cohesion: 0.21
Nodes (8): AuthedUser, requireAdmin(), requireUser(), getAdminApp(), getAdminAuth(), getAdminFirestore(), getAdminRtdb(), sellerMerchant()

### Community 140 - "locked.vue"
Cohesion: 0.22
...
Cohesion: 0.19
Nodes (13): topSellers, topSets, available, reserved, BlockedItem, reserveItems(), AvailabilityView, availableOnly() (+5 more)
...
Cohesion: 0.07
Nodes (32): emit, { signInWithGoogle }, PaymentResultCopy, PaymentResultCta, PaymentResultPhase, usePaymentResult(), copy, { order, phase, view, paying, payNow } (+24 more)
...
Cohesion: 0.06
Nodes (31): buildHeaders(), ready(), StaffMe, state(), useMcFetch(), useStaffAuth(), busy, catalogue (+23 more)
...
Cohesion: 0.11
Nodes (19): cta, intro, pricing, pricingStats, secondary, secondaryItems, BETA_PRICING, BETA_RATE (+11 more)
...
### Community 165 - "sales/[id].vue"
Cohesion: 0.14
Nodes (9): { authedFetch }, error, loading, route, sale, statusClass, { user }, METHOD_LABELS (+1 more)

### Community 166 - "shared/payouts.ts"
Cohesion: 0.20
Nodes (20): fundEntries, categorizeFunds(), settlementBadge, settlementHint, showSettlement, computeSellerPayout(), isPayoutEligible(), isPayoutTrackable() (+12 more)
...
### Community 170 - "isOpenParcel"
Cohesion: 0.24
Nodes (11): joinPaidOrderToParcel(), JoinResult, round2(), Destination, destKey(), findOpenParcelFor(), norm(), closedReason() (+3 more)
...
### Community 191 - "sales-summary.ts"
Cohesion: 0.40
...
## Knowledge Gaps
- **1337 isolated node(s):** `graphify-mcp`, `npx`, `@modelcontextprotocol/server-sequential-thinking`, `props`, `ALL` (+1332 more)
